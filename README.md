...
erlaubt. Das Kopieren, Weiterveröffentlichen, Verteilen, Einbinden in andere
Projekte oder Veröffentlichen veränderter Fassungen ist ohne vorherige
ausdrückliche Erlaubnis von ame824 nicht gestattet.
...
Copying, republishing, distributing, incorporating the code into another
project, or publishing modified versions requires prior explicit permission
from ame824.
